...
public class ThirdTestCase {
	...
	public void Test() throws InterruptedException {
		...
		ProductPageList.put("Access Connect", "Entrata Access Connect | Smart Home Solutions for your Properties");
		ProductPageList.put("Message Center", "Message Center by Entrata | Property Communication Software");
		ProductPageList.put("Digital Marketing Bundle", "Digital Marketing Services for Multifamily Property Management");
